...
class PersonalTraitComponentSM extends React.Component{
    constructor(props){
        super(props)
        this.myChart;
    }
    ...
    componentDidUpdate(){
        ...
        this.myChart = new Chart(document.getElementById("traitsm").getContext("2d"), {
            type: 'radar',
            data: {
                labels: traitLabels,
                datasets: [{
    ...
    render(){
            return (
                    <div id={this.props.userName}><canvas id="traitsm" width="400" height="400"></canvas></div>
                );
    }
}   

export default PersonalTraitComponentSM;